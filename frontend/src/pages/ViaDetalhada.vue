  ...
  <q-page class="q-pa-sm">
    ...
    <div class="row q-col-gutter-none">
      ...
      <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
        <q-card class="q-ma-md bg-grey-3 rounded-borders linha1-height">
          <q-card-section>
      ...
      <!-- Bloco Detalhes -->
      <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 col-xl-10 col-10">
        <q-card class="q-ma-md bg-grey-3 rounded-borders linha1-height">
          <q-card-section>
      ...
      <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
        <q-card class="q-ma-md bg-grey-3 rounded-borders linha2-height">
          <q-card-section>
      ...
      <div class="col-3 col-lg-2 col-md-4 col-sm-4">
        <q-card class="q-ma-md bg-grey-3 rounded-borders linha3-height">
          <q-card-section>
      ...
      <!-- Bloco Croquis -->
      <div class="col-12">
        <q-card class="q-ma-md bg-grey-3 rounded-borders linha4-height">
          <q-card-section>
...
.linha2-height {
  min-height: 180px; /* Ajuste este valor conforme necessário */
}

.linha3-height {
  min-height: 50px; /* Ajuste este valor conforme necessário */
}

.linha4-height {
  min-height: 150px; /* Ajuste este valor conforme necessário */
}
